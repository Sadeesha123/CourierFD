                ...
                <div className="sidepalen-body h-2/3 p-3 w-full justify-center">
                    ...
                    <div className="nav-body w-full flex-col justify-center space-y-3 mt-10">
                        <ul className="space-y-5">
                            ...
                            <Link to="/performancetrack" className="mb-5"><li className="p-2 w-full bg-white  rounded-md mb-5">
                                <FontAwesomeIcon icon={faChartLine} className="mr-5"/>Performance Track</li></Link>
                            <Link to="/tickets" className="mb-5"><li className="p-2 w-full bg-white  rounded-md mb-5">
                                <FontAwesomeIcon icon={faHeadset} className="mr-5"/>Customer Support</li></Link>
                            <Link to="/CustomerHome"><li className="p-2 w-full bg-white  rounded-md mb-5">
                                <FontAwesomeIcon icon={faChainBroken} className="mr-5"/>Damage Ditection USER</li></Link>
                            <Link to="/AdminHome"><li className="p-2 w-full bg-white  rounded-md mb-5">
                                <FontAwesomeIcon icon={faChainBroken} className="mr-5"/>Damage Ditection ADMIN</li></Link>   
                        </ul>
                    </div>
