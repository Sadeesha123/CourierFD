...
function CreateOrder() {
  ...
  const validateForm = () => {
    ...
    if (!formData.receiver_email) {
      ...
      isValid = false;
    } else if (!/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(formData.receiver_email)) {
          ...
          <div className="flex flex-col items-center justify-center gap-5 p-5 common-body">
            <div className="form-body w-[60%] flex flex-col p-5 mx-auto items-center justify-center bg-white rounded-lg shadow-md shadow-slate-300">
              <form onSubmit={handleSubmit} className="flex flex-col w-full">
                ...
                <div className="flex justify-between"  style={{ display: 'contents' }}>
                  ...
                  style={{ width: '100%' }}
                    ...
                    required
                  />
                  {errors.sender_name && <span className="text-red-500">{errors.sender_name}</span>}
                </div>
                ...
                <div className="flex justify-between"  style={{ display: 'contents' }}>
                <label htmlFor="noofpieces" className="p-1 mb-2 font-semibold text-gray-600">
                    No of Pieces :
                </label>
                <input
                  style={{ width: '100%' }}
                    ...
                    required
                />
                {errors.num_pics && <span className="text-red-500">{errors.num_pics}</span>}
                </div>
                ...
                <div className="flex justify-between"  style={{ display: 'contents' }}>
                  ...
                  />
                  {errors.order_date && <span className="text-red-500">{errors.order_date}</span>}
                </div>
                ...
                <div className="flex justify-between"  style={{ display: 'contents' }}>
                  ...
                  style={{ width: '100%' }}
                    ...
                    value={formData.pre}
                  />
                  {errors.pre && <span className="text-red-500">{errors.pre}</span>}
                </div>
              </form>
            </div>
            ...
            <div className="form-body w-[60%] flex flex-col p-5 mx-auto items-center justify-center bg-white rounded-lg shadow-md shadow-slate-300">
              <form onSubmit={handleSubmit} className="flex flex-col w-full">
                <h1 className="flex items-center justify-center p-5 uppercase text-md font-semibold">Receiver Details</h1>
                ...
                <div className="flex justify-between"  style={{ display: 'contents' }}>
                  ...
                  style={{ width: '100%' }}
                    ...
                    required
                  />
                  {errors.receiver_name && <span className="text-red-500">{errors.receiver_name}</span>}
                </div>
                ...
                <div className="flex justify-between"  style={{ display: 'contents' }}>
                  ...
                  style={{ width: '100%' }}
                    ...
                    required
                  />
                  {errors.receiver_email && <span className="text-red-500">{errors.receiver_email}</span>}
                </div>
                ...
                <div className="flex justify-between"  style={{ display: 'contents' }}>
                  ...
                  style={{ width: '100%' }}
                    ...
                    required
                  />
                  {errors.receiver_mobile && <span className="text-red-500">{errors.receiver_mobile}</span>}
                </div>
              </form>
